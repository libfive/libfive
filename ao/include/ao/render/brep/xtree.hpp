...
public:
    ...
    Eigen::Matrix<double, N, _pow(2, N - 1)> norms;
    ...
    /*
     *  Look up a particular vertex normal by index
     */
    Eigen::Matrix<double, N, 1> norm(unsigned i=0) const
    { assert(i < vertex_count); return norms.col(i); }
