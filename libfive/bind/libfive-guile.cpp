...
(define-method (sinh (a <shape>)) (make-shape 'sinh a))
(define-method (cosh (a <shape>)) (make-shape 'cosh a))
(define-method (tanh (a <shape>)) (make-shape 'tanh a))
(define-method (asinh (a <shape>)) (make-shape 'asinh a))
(define-method (acosh (a <shape>)) (make-shape 'acosh a))
(define-method (atanh (a <shape>)) (make-shape 'atanh a))
