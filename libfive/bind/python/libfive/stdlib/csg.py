...
def union(a, b):
    ...
    """
    return Shape.wrap(stdlib._union(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr))
...
def intersection(a, b):
    ...
    """
    return Shape.wrap(stdlib.intersection(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr))
...
def inverse(a):
    ...
    """
    return Shape.wrap(stdlib.inverse(
        Shape.wrap(a).ptr))
...
def difference(a, b):
    ...
    """
    return Shape.wrap(stdlib.difference(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr))
...
def offset(a, o):
    ...
    """
    return Shape.wrap(stdlib.offset(
        Shape.wrap(a).ptr,
        Shape.wrap(o).ptr))
...
def clearance(a, b, offset):
    ...
    """
    return Shape.wrap(stdlib.clearance(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
...
def shell(a, offset):
    ...
    """
    return Shape.wrap(stdlib.shell(
        Shape.wrap(a).ptr,
        Shape.wrap(offset).ptr))
...
def blend_expt(a, b, m):
    ...
    """
    return Shape.wrap(stdlib.blend_expt(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
        Shape.wrap(m).ptr))
...
def blend_expt_unit(a, b, m):
    ...
    """
    return Shape.wrap(stdlib.blend_expt_unit(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
        Shape.wrap(m).ptr))
...
def blend_rough(a, b, m):
    ...
    """
    return Shape.wrap(stdlib.blend_rough(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
        Shape.wrap(m).ptr))
...
def blend_difference(a, b, m, o=0):
    ...
    """
    return Shape.wrap(stdlib.blend_difference(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
        Shape.wrap(m).ptr,
        Shape.wrap(o).ptr))
...
def morph(a, b, m):
    ...
    """
    return Shape.wrap(stdlib.morph(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
        Shape.wrap(m).ptr))
...
def loft_between(a, b, lower, upper):
    """ Produces a blended loft between a (at lower.z) and b (at upper.z),
        ...
        a and b should be 2D shapes (i.e. invariant along the z axis)
    """
    return Shape.wrap(stdlib.loft_between(
        Shape.wrap(a).ptr,
        Shape.wrap(b).ptr,
        tvec3(*[Shape.wrap(i).ptr for i in lower]),
        tvec3(*[Shape.wrap(i).ptr for i in upper])))
