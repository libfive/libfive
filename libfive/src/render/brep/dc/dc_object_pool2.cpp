...
template class ObjectPool<PseudoDCTree2, DCLeaf<2>, Intersection<2>>;
...
template PseudoDCTree2* ObjectPool<PseudoDCTree2, DCLeaf<2>, Intersection<2>>::get(
        PseudoDCTree2*, unsigned, Region<2>);
