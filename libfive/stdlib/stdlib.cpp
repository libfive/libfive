...
LIBFIVE_STDLIB rounded_box(tvec3 a, tvec3 b, libfive_float r) {
...
LIBFIVE_STDLIB reflect_x(libfive_tree t, libfive_float x0) {
    return reflect_x(Tree(t), Tree(x0)).release();
}
LIBFIVE_STDLIB reflect_y(libfive_tree t, libfive_float y0) {
    return reflect_y(Tree(t), Tree(y0)).release();
}
LIBFIVE_STDLIB reflect_z(libfive_tree t, libfive_float z0) {
...
LIBFIVE_STDLIB scale_x(libfive_tree t, libfive_float sx, libfive_float x0) {
    return scale_x(Tree(t), Tree(sx), Tree(x0)).release();
}
LIBFIVE_STDLIB scale_y(libfive_tree t, libfive_float sy, libfive_float y0) {
    return scale_y(Tree(t), Tree(sy), Tree(y0)).release();
}
LIBFIVE_STDLIB scale_z(libfive_tree t, libfive_float sz, libfive_float z0) {
...
LIBFIVE_STDLIB rotate_x(libfive_tree t, libfive_float angle, tvec3 center) {
    return rotate_x(Tree(t), Tree(angle), TreeVec3{Tree(center.x), Tree(center.y), Tree(center.z)}).release();
}
LIBFIVE_STDLIB rotate_y(libfive_tree t, libfive_float angle, tvec3 center) {
...
LIBFIVE_STDLIB taper_x_y(libfive_tree shape, tvec2 base, libfive_float h, libfive_float scale, libfive_float base_scale) {
