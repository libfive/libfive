...
LIBFIVE_STDLIB cylinder_z(
    ...
    libfive_float r, libfive_float h, vec3 base__0);
...
LIBFIVE_STDLIB rotate_z(
    ...
    libfive_tree t, libfive_float angle, vec3 center__0);
LIBFIVE_STDLIB taper_xy_z(
    ...
    libfive_tree shape, vec3 base, libfive_float height,
