//  File implement/oglplus/enums/debug_output_severity_class.ipp
//
...
//
namespace enums {
template <typename Base, template<DebugOutputSeverity> class Transform>
class EnumToClass<Base, DebugOutputSeverity, Transform>
 : public Base
{
private:
...
#  undef High
	Transform<DebugOutputSeverity::High> High;
...
#  undef Medium
	Transform<DebugOutputSeverity::Medium> Medium;
...
#  undef Low
	Transform<DebugOutputSeverity::Low> Low;
...
#  undef Notification
	Transform<DebugOutputSeverity::Notification> Notification;
...
#  undef DontCare
	Transform<DebugOutputSeverity::DontCare> DontCare;
