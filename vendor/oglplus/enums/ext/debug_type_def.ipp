//  File implement/oglplus/enums/ext/debug_type_def.ipp
//
...
#  undef Error
   OGLPLUS_ENUM_CLASS_VALUE(Error, GL_DEBUG_TYPE_ERROR)
...
#  undef DeprecatedBehavior
   OGLPLUS_ENUM_CLASS_VALUE(DeprecatedBehavior, GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR)
...
#  undef UndefinedBehavior
   OGLPLUS_ENUM_CLASS_VALUE(UndefinedBehavior, GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR)
...
#  undef Portability
   OGLPLUS_ENUM_CLASS_VALUE(Portability, GL_DEBUG_TYPE_PORTABILITY)
...
#  undef Performance
   OGLPLUS_ENUM_CLASS_VALUE(Performance, GL_DEBUG_TYPE_PERFORMANCE)
...
#  undef Other
   OGLPLUS_ENUM_CLASS_VALUE(Other, GL_DEBUG_TYPE_OTHER)
...
#  undef Marker
   OGLPLUS_ENUM_CLASS_VALUE(Marker, GL_DEBUG_TYPE_MARKER)
...
#  undef PushGroup
   OGLPLUS_ENUM_CLASS_VALUE(PushGroup, GL_DEBUG_TYPE_PUSH_GROUP)
...
#  undef PopGroup
   OGLPLUS_ENUM_CLASS_VALUE(PopGroup, GL_DEBUG_TYPE_POP_GROUP)
