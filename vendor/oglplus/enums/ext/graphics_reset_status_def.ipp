//  File implement/oglplus/enums/ext/graphics_reset_status_def.ipp
//
...
#  undef NoError
   OGLPLUS_ENUM_CLASS_VALUE(NoError, GL_NO_ERROR)
...
#  undef GuiltyContextReset
   OGLPLUS_ENUM_CLASS_VALUE(GuiltyContextReset, GL_GUILTY_CONTEXT_RESET_ARB)
...
#  undef InnocentContextReset
   OGLPLUS_ENUM_CLASS_VALUE(InnocentContextReset, GL_INNOCENT_CONTEXT_RESET_ARB)
...
#  undef UnknownContextReset
   OGLPLUS_ENUM_CLASS_VALUE(UnknownContextReset, GL_UNKNOWN_CONTEXT_RESET_ARB)
